...
public class Top {
	...
	public static void main(String[] args) {
		...
		System.out.println(" Hello! And welcome to Chess Scramble!"); // these two lines are always shown when game
																		// starts
		...
		mainMenuLoop: while (mainMenu) {
			...
			if (inputString.charAt(0) == '1') { // start a new game!
				...
				ChessMove mover = new ChessMove(chessBoard);
